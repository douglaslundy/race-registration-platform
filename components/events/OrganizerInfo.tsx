...
export default function OrganizerInfo({ name, email, phone, companyName, description }: OrganizerInfoProps) {
  return (
    <div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-1 text-sm">
        ...
        {description && <p className="text-gray-600 dark:text-gray-400 pt-1">{description}</p>}
