...
vi.mock("@/lib/db", () => ({
  db: {
    ...
    eventResultFile: { findMany: vi.fn(), findFirst: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), deleteMany: vi.fn() },
    refund: {
      aggregate: vi.fn(),
      findMany: vi.fn(),
      count: vi.fn(),
    ...
    campaign: { findMany: vi.fn(), findFirst: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn(), updateMany: vi.fn(), delete: vi.fn() },
