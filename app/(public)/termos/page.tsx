  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 dark:text-gray-300">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Responsabilidade do atleta</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Pagamentos e reembolsos</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Alterações nos termos</h2>
